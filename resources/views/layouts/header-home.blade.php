        ...
        <div class="section-padding">
            <div class="section-container">
                <div class="row">
                    ...
                    <div
                        class="col-xl-4 col-lg-4 col-md-4 col-sm-3 col-3 header-right"></div>
                </div>
            </div>
        </div>
                                ...
                                <nav id="main-navigation">
                                    <ul id="menu-main-menu" class="menu">
                                        <li class="level-0 menu-item current-menu-item">
                                            <a href="/"><span class="menu-item-text">ANA SAYFA</span></a>
                                        </li>
                                        ...
                                        <li class="level-0 menu-item menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                @foreach(\App\ProductCategory::orderBy('name')->get() as $category)
                                                <li>
