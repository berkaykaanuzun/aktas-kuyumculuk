...
@section('title', ($product->title ?? $product->name ?? 'Ürün Detayı') . ' - Aktaş Kuyumculuk')
@section('meta_description', strip_tags($product->description ?? 'Ürün açıklaması bulunmamaktadır.'))
@section('og_title', ($product->title ?? $product->name ?? 'Ürün Detayı') . ' - Aktaş Kuyumculuk')
@section('og_description', strip_tags($product->description ?? 'Ürün açıklaması bulunmamaktadır.'))
@section('og_type', 'product')
@section('og_image', Voyager::image($product->image ?? 'media/product/1.jpg'))
@section('twitter_title', ($product->title ?? $product->name ?? 'Ürün Detayı') . ' - Aktaş Kuyumculuk')
@section('twitter_description', strip_tags($product->description ?? 'Ürün açıklaması bulunmamaktadır.'))
@section('twitter_image', Voyager::image($product->image ?? 'media/product/1.jpg'))
