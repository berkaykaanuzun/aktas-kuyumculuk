...
@section('title', $blog->title . ' - Aktaş Kuyumculuk Blog')
@section('meta_description', strip_tags($blog->description ?? 'Blog yazısı açıklaması bulunmamaktadır.'))
@section('og_title', $blog->title . ' - Aktaş Kuyumculuk Blog')
@section('og_description', strip_tags($blog->description ?? 'Blog yazısı açıklaması bulunmamaktadır.'))
@section('og_type', 'article')
@section('og_image', Voyager::image($blog->image ?? 'media/blog/1.jpg'))
@section('twitter_title', $blog->title . ' - Aktaş Kuyumculuk Blog')
@section('twitter_description', strip_tags($blog->description ?? 'Blog yazısı açıklaması bulunmamaktadır.'))
@section('twitter_image', Voyager::image($blog->image ?? 'media/blog/1.jpg'))
