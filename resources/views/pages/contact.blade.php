...
@section('title', 'İletişim - ' . setting('site.title', 'Aktaş Kuyumculuk'))
            ...
            <div id="primary" class="content-area">
                ...
                <div id="content" class="site-content" role="main">
                    <div class="page-contact">
                                                ...
                                                <div class="col-md-4 sm-m-b-30">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="item-content">
                                                            <a href="tel:{{ setting('iletisim.phone', '05011332103') }}">{{ setting('iletisim.phone', '05011332103') }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 sm-m-b-30">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="item-content">
                                                            <a href="https://maps.app.goo.gl/bjZSamUqUUgeNQoB9">{{ setting('iletisim.adress', 'Sancak, 42250 Selçuklu/Konya') }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="info-item">
                                                        ...
                                                        <div class="item-content">
                                                            <a href="mailto:{{ setting('iletisim.email', 'info@aktaskuyumculuk.com') }}">{{ setting('iletisim.email', 'info@aktaskuyumculuk.com') }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <section class="section section-padding p-t-70 p-b-70 m-b-0">
                            <div class="section-container small">
                                <!-- Block Contact Form -->
                                <div class="block block-contact-form">
                                    <div class="block-widget-wrap">
                                        <div class="block-title">
                                            <h2>Sorularınızı Gönderin!</h2>
                                            <div class="sub-title">
                                            ...
                                            <form
                                                ...
                                                <div class="contact-us-form">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-6">
                                                            <label class="required">E-posta</label><br />
                                                            <span class="form-control-wrap">
                                                                <input
                                                                    type="email"
                                                                    name="email"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label class="required">Mesaj</label><br />
                                                            <span class="form-control-wrap">
                                                                <textarea
                                                                    name="message"
                                                                    cols="40"
                        ...
                        <section class="section section-padding">
                            <div class="section-container small">
                                ...
                                <div class="block block-contact-map">
                                    <div class="block-widget-wrap">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6292.0326845137515!2d32.51108169459871!3d37.95340439759363!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14d08e17de6fdd7f%3A0x8cd7fb6941994534!2sAKTA%C5%9E%20KUYUMCULUK!5e0!3m2!1str!2str!4v1751377435330!5m2!1str!2str"
