...
@section('title', 'Ana Sayfa - ' . setting('site.title', 'Aktaş Kuyumculuk'))
        ...
        <div id="main-content" class="main-content">
            <div id="primary" class="content-area">
                <div id="content" class="site-content" role="main">
                    ...
                    <section class="section m-b-70 bg-theme-2">
                        <!-- Block Intro -->
                        <div class="block block-intro">
                            <div class="row">
                                <div class="section-column left">
                                    <div class="intro-wrap">
                                        <h2 class="intro-title text-white">
                                            El İşçiliği<br />
                                            &amp; Etik Kaynaklı
                                        </h2>
                                        <div class="intro-item">
                                            ...
                                            <div class="content">
                                                <h3 class="title text-white">ADİL FİYATLANDIRMA</h3>
                                                <div class="text text-white-90">
                                                    Kaliteli ürünlerimizi uygun fiyatlarla sunuyoruz.
                                        ...
                                        <div class="intro-item">
                                            ...
                                            <div class="content">
                                                <h3 class="title text-white">YÜKSEK KALİTE</h3>
                                                <div class="text text-white-90">
                                                    En kaliteli malzemeler ve işçilik ile üretilen
                                                    takılarımız uzun yıllar kullanım için
                                                    tasarlanmıştır.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="intro-btn">
                                            <a
                                                href="/kurumsal"
                                                class="button button-black button-arrow animation-horizontal">DAHA FAZLA BİLGİ</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="section-column right">
                                            ...
                                            <div class="block-widget-banner m-b-15">
                                                <div class="bg-banner">
                                                    <div class="banner-wrapper banners">
                                                        ...
                                                        <div class="banner-wrapper-infor banner-wrapper-info-left">
                                                            <div class="info">
                                                                <div class="content">
                                                                    <h3 class="title-banner">
                                                                        Yaz Koleksiyonu
                                                                    ...
                                                                    <div class="banner-image-description">
                                                                        Tatlı su inci kolye ve küpe seti
                                                                    </div>
                                                                    <a
                                            ...
                                            <div class="block-widget-banner">
                                                <div class="bg-banner">
                                                    <div class="banner-wrapper banners">
                                                        ...
                                                        <div class="banner-wrapper-infor banner-wrapper-info-right">
                                                            <div class="info">
                                                                <div class="content">
                                                                    <h3 class="title-banner">
                                                                        Unutulmaz Kılın
